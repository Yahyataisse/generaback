...
<head>
  ...
  <title>Welcome to Genera AI</title>
  <style>
    body {{
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://i.postimg.cc/WdNtRx5Z/kortix-suna-logo.png" alt="Genera AI Logo" class="logo">
    </div>
    <h1>Welcome to Genera AI!</h1>

    <p>Hi {user_name},</p>

    <p><em><strong>Welcome to Genera AI — we're excited to have you on board!</strong></em></p>
