...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Genera AI',
    description: 'Replay this Agent conversation on Genera AI',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Genera AI';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Genera AI';
